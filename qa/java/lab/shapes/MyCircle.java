...
public class MyCircle extends MyShape implements Drawable
{
	...
	MyCircle(int centreX, int centreY, int radius)
	{
		super((centreX - radius), (centreY - radius), (radius*2), (radius*2) );
	}
